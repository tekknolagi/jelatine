...
static bool decodeDynamicHuffmanTables(inflaterState *state,
...
static bool inflateHuffman(inflaterState *state, bool fixedHuffman);
static bool inflateStored(inflaterState *state);
 ...
 *=======================================================================*/
static bool
inflateHuffman(inflaterState *state, bool fixedHuffman)
{
    DECLARE_IN_VARIABLES
    DECLARE_OUT_VARIABLES

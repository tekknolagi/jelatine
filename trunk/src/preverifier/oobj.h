...
bool IsSameClassPackage(ClassClass *class1, ClassClass *class2);
unsigned Signature2ArgsSize(char *method_signature);
char *GetClassConstantClassName(cp_item_type *constant_pool, int index);
ClassClass *FindClass(struct execenv *ee, char *name, bool resolve);
ClassClass *FindClassFromClass(struct execenv *ee, char *name,
                   bool resolve, ClassClass *from);

bool createInternalClass(unsigned char *bytes, unsigned char *limit,
                           ClassClass *cb, struct Hjava_lang_ClassLoader *,
                            char *utfname, char **detail);

bool VerifyClass(ClassClass *cb);
bool IsLegalClassname(char *name, bool allowArrayClass);
bool verify_class_codes(ClassClass *cb);
...
ClassClass *FindStickySystemClass(struct execenv *, char *, bool resolve);
bool VerifyClassAccess(ClassClass *, ClassClass *, bool);
void InitializeInvoker(ClassClass *cb);
bool RunStaticInitializers(ClassClass *cb);
ClassClass *ClassLoaderFindClass(ExecEnv *ee,
                 struct Hjava_lang_ClassLoader *loader,
                 char *name, bool resolve);
...
bool isJARfile(char *fn, int length);
...
extern bool no_native_methods;
extern bool no_floating_point;
extern bool no_finalizers;
